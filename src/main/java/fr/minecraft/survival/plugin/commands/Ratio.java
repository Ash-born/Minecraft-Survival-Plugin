    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        if (p.isOp()) {
            if (strings.length >= 1) {
                ...
                int netherrackMined = config
                        .getInt("ancientDebritMined." + suspect.getDisplayName() + ".netherrackMined");
                int ancientDebritMined = config
                        .getInt("ancientDebritMined." + suspect.getDisplayName() + ".ancientDebritMined");
                double ratioAncientDebrit = config
                        .getDouble("ancientDebritMined." + suspect.getDisplayName() + ".ratio");
